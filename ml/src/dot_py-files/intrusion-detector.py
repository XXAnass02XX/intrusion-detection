...
data_columns = pd.read_csv('../../used-logs/conn.log' , sep='\t', skiprows=6, nrows=1, header=None).iloc[0][1:]
data_df = pd.read_csv('../../used-logs/conn.log', sep='\t', comment='#',header=None)
...
#IMPORT MODEL AND APPLY IT
#TODO fix the NaN values for the 2/3 models
...
data_df.to_csv("../../used-logs/logs-processed.csv")
